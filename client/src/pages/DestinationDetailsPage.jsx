      ...
      <section className="relative min-h-[30rem] overflow-hidden rounded-[2rem] shadow-2xl shadow-orange-100">
        ...
        <div className="absolute inset-x-0 bottom-0 p-6 text-white sm:p-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <button type="button" className="inline-flex items-center gap-2 rounded-full bg-white/15 px-6 py-3 text-sm font-black text-white backdrop-blur transition hover:bg-white/25">
